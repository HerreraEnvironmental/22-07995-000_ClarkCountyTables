...
# 
# table2 <- cleaned.data %>%
#   select(Watershed, Subreach, Area = Sum.of.Area_Acre, Impervious_Cover2013 = Sum.of.ImperviousAcre2013,
#          Impervious_Cover2019 = Sum.of.ImperviousAcre2019, Shoreline_Cleared = Sum.of.P_ClearingFootprint_Acre_12_22,
#          Shoreline_Enhanced = Sum.of.P_MitigationRestoration_Acre_12_22, 
#          DNR_Cleared = Sum.of.ForestPracticesAcre_13_19) %>%
